...
internal sealed class ConsoleApplicationEngine
{
    ...
    private string BuildNetworkRez()
    {
        ...
        net2.AppendLine("    N        Vрас         dV         P         Q        Pg       Qb");
        ...
        net2.AppendLine("   N1   N1       Pнач       Qнач       Pкон       Qкон       dP   Iнач    Iкон    Iдоп   Загр,%");
        ...
        for (int j = 1; j <= m; j++)
        {
            ...
            net2.AppendLine($"{nn[i1],5}{nn[i2],5}{F2(-p12),10}{F2(-q12),10}{F2(p21),10}{F2(q21),10}{F2(dpl),10}{F2(iStartAmperes),10}{F2(iEndAmperes),10}");
